...
export const metadata = {
  title: "About Dr. Zaid Gul | Specialist Gastroenterologist",
  description:
    "Learn about Dr. Zaid Gul — a highly distinguished Specialist Gastroenterologist & Hepatologist with over 8 years of clinical excellence.",
};
...
export default function AboutPage() {
  ...
  return (
    <main className="pt-24 overflow-x-hidden">
      ...
      <section className="py-xl px-gutter max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl items-center">
          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="relative rounded-xl overflow-hidden aspect-[4/5] border border-outline-variant/20 shadow-xl">
              <Image
                src={profile_image}
                alt={name}
                fill
          ...
          <div className="lg:col-span-7 space-y-md">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-md pt-md">
              ...
              <div className="space-y-1">
                <span className="text-headline-md font-semibold text-primary">5k+</span>
                <p className="text-caption text-outline uppercase tracking-widest">
            ...
            <div className="flex flex-wrap gap-sm pt-md">
              <Link
                ...
                className="bg-primary text-on-primary px-lg py-sm rounded-xl text-label-md font-semibold hover:opacity-90 transition-all shadow-lg"
              >
                Book Consultation
              </Link>
              <Link
                href="/services"
                className="border border-outline-variant text-on-surface px-lg py-sm rounded-xl text-label-md font-semibold hover:bg-surface-container transition-all"
              >
                View Services
              </Link>
            </div>
        ...
        <div className="max-w-[1280px] mx-auto px-gutter">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-xl">
            ...
            <div className="lg:col-span-2 space-y-md">
              ...
              <div className="pt-md grid grid-cols-1 sm:grid-cols-2 gap-md">
                <div className="bg-surface-container-lowest p-md rounded-xl border border-outline-variant/10 shadow-sm">
      ...
      <section className="py-xl px-gutter max-w-[1280px] mx-auto">
        <h2 className="text-headline-lg font-bold mb-xl text-center text-on-surface">
          ...
          <div className="space-y-xl">
            {TIMELINE.map((item, i) => (
              ...
              >
                ...
                <div className="h-4 w-4 rounded-full bg-primary ring-4 ring-primary-fixed z-10 hidden md:block shrink-0" />
                <div
