              ...
              <div className="space-y-md">
                {PREP_STEPS.map((step) => (
                  <div key={step.num} className="flex gap-md group">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-primary-fixed flex items-center justify-center text-primary font-semibold text-headline-md group-hover:scale-110 transition-transform">
                      {step.num}
                    </div>
                    <div>
